...
const COLUMN = [
  {
    ...
    zhBody: [
      ...
      "But，倘若「朔月」發生在初一的 23:59（子初四刻與子時正刻的交接點或之前），農曆的十五，月球本身實際上才走了約 13 天的行程，偏慢所以尚未走到與太陽相差 180° 的「望」點，還沒到全面發光，滿月就會延後到農曆十六，甚至是十七日的凌晨，類似本月、此時的情況，俗語：「十五的月亮沒有十六圓」，正是由此而來。",
      "苗栗♡格蘭傑舉手提問：",
      ...
      COLUMN_SEP,
      "備註：本輪「望、滿月」的精確時刻為台灣時間 2026 年 7 月 29 日 22:35，農曆為六月十六，正是文中所說的「滿月延後到十六」，7/29 晚間，夜空中將出現真正的滿月。App 內「宇宙」分頁的新月／滿月節點已全面改以真實朔望時刻計算，並依你裝置所在時區顯示日期。",
    ],
    enBody: [
