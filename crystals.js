/* ============================================================
   ...
   非科學實證、非醫療建議。想編修水晶，直接編輯 CRYSTAL_DB 即可。
   ============================================================ */
...
const CRYSTAL_DB = [
  ...
  { id: "amethyst", zh: "紫水晶", en: "Amethyst", alias: "智慧之石", family: "石英家族",
    ...
    origin: "烏拉圭・巴西",
    fx: ["安定心神、化解焦慮", "提升直覺與智慧", "助眠、緩和多夢", "招貴人、增進人際包容"],
    uses: ["靈性", "平靜", "睡眠"], nm: 2, fm: 3,
    moonNote: "滿月夜放窗邊充能；睡前握著做釋放儀式，將煩惱交還月亮。",
  ...
  { id: "green-phantom", zh: "綠幽靈", en: "Green Phantom Quartz", alias: "事業水晶", family: "石英家族",
    ...
    lore: "晶體生長中斷時覆上綠泥石，再繼續生長包裹成「山」狀，像被封存的時間切片，故名 phantom（幻影）。" },
  ...
  { id: "strawberry-quartz", zh: "草莓晶", en: "Strawberry Quartz", alias: "人緣桃花石", family: "石英家族",
    ...
    moonNote: "新月社交願望：想拓展人際圈、遇見對的人時配戴。",
  ...
  { id: "ametrine", zh: "紫黃晶", en: "Ametrine", alias: "智慧與財富的雙生", family: "石英家族",
    ...
    origin: "玻利維亞",
    fx: ["同時匯聚紫水晶的智慧與黃水晶的財氣", "整合理性與直覺", "化解猶豫、果斷決策", "調和矛盾情緒"],
  ...
  { id: "carnelian", zh: "紅玉髓", en: "Carnelian", alias: "行動之火", family: "石英家族",
    ...
    moonNote: "新月啟動新計畫的「點火石」：把待辦事情的第一步寫下，壓在紅玉髓之下協助啟動。",
    cleanse: ["月光", "日光", "流水"], avoid: [],
  ...
  { id: "blue-lace-agate", zh: "藍紋瑪瑙", en: "Blue Lace Agate", alias: "溫柔溝通石", family: "石英家族",
    ...
    origin: "納米比亞",
    fx: ["柔化言語、化解衝突", "支持誠實而溫柔的表達", "安撫焦慮與緊張", "適合在眾人前談話與面談前配戴"],
  ...
  { id: "moonstone", zh: "月光石", en: "Moonstone", alias: "月亮女神之石", family: "長石家族",
    ...
    origin: "斯里蘭卡・印度",
    fx: ["連結月亮週期與直覺", "溫柔滋養女性能量", "安撫情緒潮汐、助眠", "招正緣、提升自我魅力氣場與守護旅人外出運勢"],
  ...
  { id: "labradorite", zh: "拉長石", en: "Labradorite", alias: "極光之石", family: "長石家族",
    ...
    origin: "馬達加斯加・芬蘭",
    fx: ["築起能量防護罩、防能量避吸血鬼", "喚醒直覺與潛能", "陪伴人生轉換期", "增添神秘魅力"],
    uses: ["守護", "靈性", "創造"], nm: 2, fm: 2,
    moonNote: "月蝕、變動月相時的護身石；轉職、搬家等轉變期新月許願。",
    cleanse: ["月光", "晶簇", "薰香"], avoid: [],
    lore: "因紐特傳說極光曾被封在拉布拉多海岸的岩石裡，戰士以長矛劈開釋放，留在石中的光成了拉長石暈彩。" },
  ...
  { id: "sunstone", zh: "太陽石", en: "Sunstone", alias: "領袖之石", family: "長石家族",
    ...
    origin: "印度・挪威・美國奧勒岡",
    fx: ["注入樂觀與生命力", "增強領導魅力", "驅散陰霾、抵抗低潮", "鼓勵自我照顧與勇敢說：「不」"],
  ...
  { id: "amazonite", zh: "天河石", en: "Amazonite", alias: "希望之石", family: "長石家族",
    ...
    origin: "秘魯・莫三比克・俄羅斯",
    fx: ["帶來希望與翻轉局面的勇氣", "誠實表達內心真話", "舒緩神經緊繃", "傳統上被視為試試手氣的幸運石"],
    uses: ["溝通", "勇氣", "財富"], nm: 2, fm: 1,
    moonNote: "新月替「想再試一次」的願望打氣：重考、復出、東山再起。",
    cleanse: ["月光", "流水", "晶簇"], avoid: [],
    lore: "以亞馬遜河為名（雖然當地並不產）；圖坦卡門的聖甲蟲胸飾與《死者之書》護符都使用了天河石。" },
...
const CRYSTAL_RITUALS = {
  ...
  charge: { icon: "🌝", name: "滿月消磁・充能月光浴", when: "滿月夜（陰天也有效，月光穿雲）",
    ...
    steps: [
      "把常戴的水晶取下，用軟布輕拭灰塵與皮脂",
      "檢查禁忌：怕水的（透石膏／孔雀石／黃鐵礦／天使石）跳過流水，直接曬月光",
      "放在窗台或陽台（窗戶玻璃內側也可），托盤鋪白布或放透石膏板上加乘",
      "月光浴一夜；日出前收回（怕曬的紫晶、粉晶請避開陽光直射）",
  ...
  grid: { icon: "✨", name: "顯化水晶陣 Crystal Grid", when: "任何想加強顯化的時刻，新月尤佳",
    ...
    steps: [
      "選一個主題（財富／愛情／健康），中心放一顆主水晶（原石或晶柱最佳，能量指向宇宙）",
      "外圈以 6 或 8 顆小水晶對稱圍繞（幾何對稱＝意圖聚焦），可墊神聖幾何陣布",
      "把寫好的願望紙折小放在主水晶原石下方",
      "用一根白水晶柱從外圈依序「畫線」連到中心，像接通電路、連接宇宙訊號",
      "放在不受打擾的角落至少一個月相週期（約 29.5 天），每逢新月滿月靜心一分鐘重新觀想",
    ] },
};
